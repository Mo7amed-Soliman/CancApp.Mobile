...
class DoctorChatHeader extends StatefulWidget {
  const DoctorChatHeader({super.key});

  @override
  State<DoctorChatHeader> createState() => _DoctorChatHeaderState();
}

class _DoctorChatHeaderState extends State<DoctorChatHeader>
