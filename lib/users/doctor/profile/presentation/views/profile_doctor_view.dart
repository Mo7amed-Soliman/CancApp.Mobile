...
import 'package:canc_app/users/patient/profile/presentation/view/widgets/profile_menu_tile.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:go_router/go_router.dart';
import 'package:iconly/iconly.dart';

class ProfileDoctorView extends StatefulWidget {
  const ProfileDoctorView({super.key});

  @override
  State<ProfileDoctorView> createState() => _ProfileDoctorViewState();
}

class _ProfileDoctorViewState extends State<ProfileDoctorView> {
    ...
    return Column(
      children: [
        ...
        ProfileMenuTile(
          ...
          onTap: () async {
            context.push(Routes.accessRequestsDoctorView);
          },
        ),
        ProfileMenuTile(
